inherited fmScheduler: TfmScheduler
  Left = 404
  Top = 134
  Width = 588
  Height = 507
  ...
  inherited mnuPrincipal: TdxBarManager
    ...
    DockControlHeights = (
      ...
      104
      0)
    inherited mnuEdicion: TdxBarSubItem
      ItemLinks = <
        item
          Item = mnuDeshacer
          Visible = True
        ...
        item
          BeginGroup = True
          Item = mnuSelDependencias
          Visible = True
        end>
    end
    object mnuSelDependencias: TdxBarSubItem
      Caption = 'Seleccionar Dependencias'
      Category = 0
      Visible = ivAlways
      ItemLinks = <
        item
        ...
        item
          Item = mnuSelDepArriba
          Visible = True
        end>
    end
    object mnuSelDepAbajo: TdxBarButton
      Caption = 'Hacia Abajo'
      Category = 0
      Hint = 'Hacia Abajo'
      Visible = ivAlways
      ShortCut = 49220
      OnClick = mnuSelDepAbajoClick
    end
    object mnuSelDepArriba: TdxBarButton
      Caption = 'HaciaArriba'
      Category = 0
      Hint = 'HaciaArriba'
      Visible = ivAlways
      ShortCut = 49236
      OnClick = mnuSelDepArribaClick
    end
  end
end
