...
implementation
uses
   ptsdm, ptsgral, uDiagramaRutinas, ADODB, FlowchartBlocks;

{$R *.dfm}

procedure TfmScheduler.PubGeneraDiagrama( sParClase, sParBib, sParProg: String;
   sParCaption: String );
begin
...
procedure TfmScheduler.PriArmaDiagrama( sParClase, sParBib, sParProg: String;
   sParSubtitulo: String );
var
   i: Integer;
...
begin
   ...
   iRepetido := dgr_repetido( sParClase, sParBib, sParProg, 0, 0, '' );
...
procedure TfmScheduler.PriLogicaArmado( sParClase, sParBib, sParProg: String );
type
...
begin
   ...
   PriTaladrar( sParClase, sParBib, sParProg, '' ); //obtiene datos de Tsrela
