...
procedure TftsListaDependencias.FormCreate( Sender: TObject );
begin
...
begin
   b_impresion := true;
   Warchivo := g_tmpdir + '\LD' + W_nomcomponente + 'IMP.html';
...
begin
   ...
   Hoja.Cells.Item[ 2, 2 ] := 'Lista Dependencias:'+bgral;
...
begin
   ...
   Wtexto := 'LISTA DEPENDENCIAS: ' + Wclase + ' ' + Wbib + ' ' + Wprog;
   ...
   Warchivo := g_tmpdir + '\LD' + W_nomcomponente + '.html';
...
//   end;
   ...
   application.MessageBox( pansichar(Wmens), 'Lista Dependencias de Componentes ', MB_OK );
end;
