object ftsrecjava: Tftsrecjava
  Left = 353
  Top = 0
  Width = 988
  Height = 740
  Caption = 'Sys-Mining  -  Recepci'#243'n Sistemas Java'
  Color = clBtnFace
  ...
  object GroupBox2: TGroupBox
    ...
    object chkgoogle: TCheckBox
      Left = 6
      Top = 504
      Width = 105
      Height = 17
      Caption = 'Activa B'#250'squeda'
      TabOrder = 11
      Visible = False
    end
    object blog: TButton
    ...
    object ypath: TPanel
      ...
      object Panel1: TPanel
        ...
        object braiz: TButton
          ...
          Width = 130
          Height = 20
          Caption = 'Nodo ra'#237'z'
          TabOrder = 0
          OnClick = braizClick
        end
        object txtraiz: TEdit
          Left = 7
          Top = 33
          Width = 169
          Height = 21
