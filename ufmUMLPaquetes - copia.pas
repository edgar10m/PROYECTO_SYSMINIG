...
type
   ...
   private
      ...
      procedure PriLogicaArmado_PCK( sParClase, sParBib, sParProg: String );
      procedure PriLogicaArmado_JAV( sParClase, sParBib, sParProg: String );
...
procedure TfmUMLPaquetes.PubGeneraDiagrama( sParClase, sParBib, sParProg: String;
   sParCaption: String );
begin
...
procedure TfmUMLPaquetes.PriArmaDiagrama( sParClase, sParBib, sParProg: String;
   sParSubtitulo: String );
var
   i: Integer;
...
begin
   ...
   if sParClase = 'PCK' then
      PriLogicaArmado_PCK( sParClase, sParBib, sParProg )
   else
      PriLogicaArmado_JAV( sParClase, sParBib, sParProg );
...
procedure TfmUMLPaquetes.PriLogicaArmado_PCK( sParClase, sParBib, sParProg: String );
var
   iRepetido: integer;
   qPaquetes: Tadoquery;
      ...
      if dm.sqlselect( qPaquetes,
         ...
         with qPaquetes do begin
            while not Eof do begin
               ...
               iRepetido := dgr_repetido( sParClase, sParBib, sNombrePaquete, 0, 0, '' );
...
procedure TfmUMLPaquetes.PriLogicaArmado_JAV( sParClase, sParBib, sParProg: String );
var
   iRepetido: integer;
   qPaquetes: Tadoquery;
