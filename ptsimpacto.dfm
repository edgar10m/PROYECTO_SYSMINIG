object ftsimpacto: Tftsimpacto
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object web1: TWebBrowser
        ...
        ControlData = {
          4C000000BC3E00008C2C00000000000000000000000000000000000000000000
    ...
    object TabSheet2: TTabSheet
      ...
      Caption = 'Diagrama'
      ImageIndex = 1
      object atDiagramAnalisisImpacto: TatDiagram
        Left = 0
        Top = 0
        Width = 601
        Height = 409
        ...
        WheelZoomMin = 10
        WheelZoomMax = 500
        OnSelectDControl = atDiagramAnalisisImpactoSelectDControl
        OnDControlDblClick = atDiagramAnalisisImpactoDControlDblClick
        Align = alClient
        ...
        ShowHint = False
        TabOrder = 0
        OnMouseUp = atDiagramAnalisisImpactoMouseUp
      end
      object DgrTransparencySelector: TDgrTransparencySelector
        ...
        TabOrder = 1
        Version = '2.0.0.0'
        Diagram = atDiagramAnalisisImpacto
  ...
  object SaveDialog: TSaveDialog
    DefaultExt = '*.dgr'
    Filter = 'Diagram files(*.dgr)|*.dgr|WMF files(*.wmf)|*.wmf'
    FilterIndex = 0
    Left = 400
    Top = 40
  end
